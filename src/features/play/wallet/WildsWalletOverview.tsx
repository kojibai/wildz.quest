...
export function WildsWalletOverview({ state, onNavigate }: { state: WildsWalletControllerState; onNavigate(page: "send" | "receive"): void }) {
  ...
  return <section aria-labelledby="wilds-wallet-overview-title" className="wilds-wallet-overview">
    <header className="wilds-wallet-balance-band">
      <span><small id="wilds-wallet-overview-title">ADMITTED PHI</small><strong>{formatWildsPhiExact(summary.admittedPhiMicro)} <i>Φ</i></strong></span>
