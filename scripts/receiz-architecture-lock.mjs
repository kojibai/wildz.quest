...
if (pkg.dependencies?.["@receiz/sdk"] !== "123.0.0") failures.push("receiz_sdk_pin_mismatch");
if (pkg.devDependencies?.["@receiz/mcp-server"] !== "123.0.0") failures.push("receiz_mcp_pin_mismatch");
if (pkg.devDependencies?.["@receiz/ai-skills"] !== "123.0.0") failures.push("receiz_ai_skills_pin_mismatch");
