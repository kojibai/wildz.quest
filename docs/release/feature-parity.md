...
| Receiz application contract | V104 compiler declares artifact-first authority with database authority disabled; the repository checker validates Record-before-Seal, durable proof memory, continuity, idempotency, and browser-safe secrets | `receiz.app.json`, `receiz.generated.json`, `tests/receiz-v104-app-contract.test.ts` |
