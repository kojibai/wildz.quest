...
Profile showcases use literal `profile-showcase:<owner>` identity, carry successor history in sealed bytes, and create no new signer, issuer, or head authority. Profile and economy genesis/append/merge planning is zero-write and requires the exact v116 registry/matrix evidence; economy merges additionally require verified sibling heads.
...
- `wildz-market-operator-skill`: use native v116 bearer ownership and fail closed on unavailable admission.
