...
describe("Wilds canonical card authority", () => {
  it("requires cards for creature acts while leaving baseline gathering available to the explorer", () => {
    ...
    assert.equal(worldCommandRequiresCard({ type: "resource.material.harvest", source: {} as never, sourceHead: "sha256:" + "1".repeat(64), actorPosition: { x: 0, z: 0 }, commandId: "command:harvest" }), false);
