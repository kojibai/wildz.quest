...
if (pkg.dependencies?.["@receiz/sdk"] !== "124.0.3") failures.push("receiz_sdk_pin_mismatch");
if (pkg.devDependencies?.["@receiz/mcp-server"] !== "124.0.3") failures.push("receiz_mcp_pin_mismatch");
if (pkg.devDependencies?.["@receiz/ai-skills"] !== "124.0.3") failures.push("receiz_ai_skills_pin_mismatch");
