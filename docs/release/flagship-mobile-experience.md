...
| E13 | `claimIndex` |
| E14 | Tracked bundle `docs/release/evidence/final-integration/`: manifest `final-integration-evidence-manifest.json` (SHA-256 `a2654c6e4129b08fd3afc87ab23ff33c6599ea1a779b1a5c5860ec08a47bb11a`), replay script (SHA-256 `0cbc544102b97e5268f89a33f11e24a18446dbc311dd9f5fea9666254af314f9`), structured result (SHA-256 `0a7fd11f3c8589cd406a473a0fbf4ce751239f733363221f02cfcd48cd27fa9c`), five hashed screenshots, and tracked final report — exact production commit/build, listener-before-navigation, modal lifetime, ability, owner-cancellation, and gate evidence |
