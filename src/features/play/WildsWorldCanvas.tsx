...
function AerialPlayerFrame({ aquaticPresentation, capabilities, children, onEnergyChange, onModeChange, player, runtime }: {
  aquaticPresentation: WildsAquaticPresentation;
