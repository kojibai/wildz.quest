...
| E13 | `claimIndex` |
| E14 | Tracked bundle `docs/release/evidence/final-integration/`: manifest `final-integration-evidence-manifest.json` (SHA-256 `2d48c7435e9b951884c4764b626dbdd1cad8545cee544b15e500e8c76de26a04`), replay script (SHA-256 `0cbc544102b97e5268f89a33f11e24a18446dbc311dd9f5fea9666254af314f9`), structured result (SHA-256 `0a7fd11f3c8589cd406a473a0fbf4ce751239f733363221f02cfcd48cd27fa9c`), executable validator `validate-final-integration-evidence.mjs` (SHA-256 `12dbea34ea626d019f9b86beb297206125fe19f79ab02bfbe9b85217d852d2cd`), five hashed screenshots, and tracked final report — exact production commit/build, listener-before-navigation, modal lifetime, ability, owner-cancellation, and gate evidence |
