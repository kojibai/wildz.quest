...
export function createWildsCardSendDraft(
  ...
  const text = [
    ...
    `Open the attached Receiz-sealed artifact in Wildz, Receiz, or another v116-compatible application.`,
...
/** Extracts the opaque legacy carrier. Only the v116 SDK may open these bytes. */
...
/** @deprecated Test-only carrier helper. Native v116 artifacts must never be wrapped. */
