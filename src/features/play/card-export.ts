...
/** Extracts the opaque legacy carrier. Only the v111 SDK may open these bytes. */
...
/** @deprecated Test-only carrier helper. Native v111 artifacts must never be wrapped. */
