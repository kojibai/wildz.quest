...
Receiz proof authority is the source of identity, artifact, ownership, and causal truth. Target Wildz `3.0.0` and Receiz major 105 without reimplementing SDK verification.
...
5. Preserve `receiz.app.json` as the artifact-first v105 application contract with database authority disabled. Run the App Contract Compiler/checker after changing identity, proof, proof memory, public-store, commerce, framework, environment, or generated integration surfaces.
