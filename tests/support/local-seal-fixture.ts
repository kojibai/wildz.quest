...
import { insertPngTextChunks } from "../../src/lib/receiz/local-seal/reference/pngChunks";
...
export async function signedLocalCardFixture() {
  ...
  const unknown = insertPngTextChunks(png, [{ keyword: "another.application", text: "preserve exactly" }]);
