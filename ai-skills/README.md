# Wildz v111 AI operating doctrine

Wildz is aligned only to `@receiz/ai-skills@111.0.0`, `@receiz/sdk@111.0.0`, and `@receiz/mcp-server@111.0.0` from the official npm registry. All procedures bind to registry digest `cf02d0bce6ad1541cfe84e27bfb1036777b29616bf8a1e5aeafb899a945e359a` and artifact laws `ARTIFACT-001` through `ARTIFACT-020`.
...
- `wildz-market-operator-skill`: use native v111 bearer ownership and fail closed on unavailable admission.
