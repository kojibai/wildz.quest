...
/** Extracts the opaque legacy carrier. Only the v110 SDK may open these bytes. */
...
/** @deprecated Test-only carrier helper. Native v110 artifacts must never be wrapped. */
